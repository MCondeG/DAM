...
public class MyProfesorRecyclerViewAdapter extends RecyclerView.Adapter<MyProfesorRecyclerViewAdapter.ViewHolder> {
    ...
    private final ProfesorFragment.OnListFragmentInteractionListener mListener;

    public MyProfesorRecyclerViewAdapter(ArrayList<Profesor> items, ProfesorFragment.OnListFragmentInteractionListener listener) {
        profesores = items;
        mListener = listener;
    }
