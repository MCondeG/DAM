...
public class ClienteGrafico extends JFrame {
	...
	public ClienteGrafico() {
		...
		suma.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(!numero1.trim().equals("") || !numero1.isEmpty())
					cadena=numero1+suma.getText()+numero2;
				cadena= conectaServer(cadena);
		...
		resta.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				String cadena="0-0";
				if(!numero1.trim().equals("") || !numero1.isEmpty())
					cadena=numero1+resta.getText()+numero2;
				cadena= conectaServer(cadena);
				resul.setText(cadena);
			}
		});
		...
		multiplica.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				String cadena="0*0";
				if(!numero1.trim().equals("") || !numero1.isEmpty())
					cadena=numero1+multiplica.getText()+numero2;
				cadena= conectaServer(cadena);
				resul.setText(cadena);
			}
		});
		...
		divide.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				String cadena="0/0";
				if(!numero1.trim().equals("") || !numero1.isEmpty())
					cadena=numero1+divide.getText()+numero2;
				cadena= conectaServer(cadena);
				resul.setText(cadena);
			}
		});
	...
	public String conectaServer(String cadena) {
