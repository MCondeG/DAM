...
import com.example.gestionrutas.modelo.entidades.Usuario;
import com.example.gestionrutas.vista.ModoDia;
import com.example.gestionrutas.vista.ModoNoche;


public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener, OnClickBoton {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager()
                .beginTransaction()
                .add(R.id.contenedor, new FormularioUsuario())
                .commit();
    ...
    public void pulsar(String nombre, String contraseña){
        ...
        getSupportFragmentManager()
                .beginTransaction()
                .add(R.id.contenedor, new VerUsuarios())
                .commit();

        TextView textView = findViewById(R.id.textView);

        textView.setText("Usuario " + nombre + " creado!");
    }
}